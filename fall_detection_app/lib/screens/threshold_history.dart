...
class _ThresholdHistoryScreenState extends State<ThresholdHistoryScreen> {
  ...
  Color _actionColor(String action) {
    switch (action.toUpperCase()) {
      case 'MORE_SENSITIVE': return _danger;
      case 'RELAX': return _accent;
      default: return _warning;
    }
  }

  @override
  static final List<FlSpot> _persistentPoints = [];
static final List<String> _persistentActions = [];

void initState() {
  super.initState();
  // Restore previous data
  _thresholdPoints.addAll(_persistentPoints);
  _actions.addAll(_persistentActions);
  _sampleCount = _persistentPoints.length;
  _startListening();
}
    ...
    _subscription = ref.onValue.listen((event) {
      ...
      try {
        ...
        setState(() {
          ...
          _thresholdPoints.add(FlSpot(_thresholdPoints.length.toDouble(), thr));
_actions.add(action);
_persistentPoints.clear();
_persistentActions.clear();
_persistentPoints.addAll(_thresholdPoints);
_persistentActions.addAll(_actions);
        });
      } catch (_) {}
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('RL Threshold History',
        ...
        actions: [
          Container(
            ...
            child: Row(children: [
              ...
              const Text('LIVE', style: TextStyle(color: _accent, fontSize: 11,
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text('${_currentThreshold.toStringAsFixed(3)} g',
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          ...
          child: Text(
            _thresholdPoints.isEmpty
                ? 'Waiting for ESP32 data...'
                : 'Last ${_thresholdPoints.length} readings',
            style: TextStyle(color: _textSecondary, fontSize: 12, fontWeight: FontWeight.w500)),
        ),
        SizedBox(
          height: 200,
          child: _thresholdPoints.isEmpty
              ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Icon(Icons.show_chart, color: _textSecondary, size: 40),
                  const SizedBox(height: 8),
                  Text('Connect ESP32 and start server',
              ...
              : LineChart(LineChartData(
                  ...
                  titlesData: FlTitlesData(
                    leftTitles: AxisTitles(sideTitles: SideTitles(
                      ...
                      reservedSize: 40,
                      interval: 0.5,
                      getTitlesWidget: (value, _) => Text('${value.toStringAsFixed(1)}g',
                    ...
                    LineChartBarData(
                      ...
                      dotData: FlDotData(
                        ...
                        getDotPainter: (spot, _, __, index) {
                          final action = index < _actions.length ? _actions[index] : 'HOLD';
                      ...
                      belowBarData: BarAreaData(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [_accent.withOpacity(0.2), _accent.withOpacity(0.0)],
                        ),
                      ),
                    ),
                  ],
  ...
  Widget _explanationRow(String title, String desc, Color color) {
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(desc, style: TextStyle(color: _textSecondary, fontSize: 11)),
      ])),
    ]);
  }
}